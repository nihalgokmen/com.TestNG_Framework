...
public class C03_SoftAssertion {
    ...
    public void softAssertionTesti(){
        ...
        /*
            ...
            Assert icine String bir mesaj yazmak
         */
        ...
        softAssert.assertAll();  // --> sonuclari ver demek

        // softAsseert objesi ile asserrtion'lari yaptiktan sonra
        // asseertAll() kullanilmazsa, test direkt PASSED olur
        // failed olan asseertion'lar raporlanmaz!
    }
}
